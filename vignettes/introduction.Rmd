...
kableExtra::kbl(harmonia$subnational_outcomes) %>% kableExtra::kable_styling(bootstrap_options = c("hover", "condensed"))
```
...
kableExtra::kbl(harmonia$tables$Harmonia_dtp3_vx_table)%>% kableExtra::kable_styling(bootstrap_options = c("hover", "condensed"))
```
